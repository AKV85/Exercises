...
final class ReverseTest extends TestCase
{
    ...
    public function testCanReverseString2WithWhitespace(): void
    {
        // self::markTestSkipped();
        self::assertSame('ytr ewq ', Reverse::string2(' qwe rty'));
    }
    public function testCanReverseString3WithWhitespace(): void
    {
        // self::markTestSkipped();
        self::assertSame('ytr ewq ', Reverse::string3(' qwe rty'));
    }
    public function testCanReverseString4WithWhitespace(): void
    {
        // self::markTestSkipped();
        self::assertSame('ytr ewq ', Reverse::string4(' qwe rty'));
    }
    public function testCanReverseString5WithWhitespace(): void
    {
        // self::markTestSkipped();
